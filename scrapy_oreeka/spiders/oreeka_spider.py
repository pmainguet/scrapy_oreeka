...
class OreekaSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        l.add_xpath('plantation','//div["tableau_periodicite"]/div/p[normalize-space(text())="Plantation"]/following-sibling::table/tr/td[@class = "_selected1 selectionne"]/text()')
        l.add_xpath('floraison','//div["tableau_periodicite"]/div/p[normalize-space(text())="Floraison"]/following-sibling::table/tr/td[@class = "_selected2 selectionne"]/text()')
        l.add_xpath('recolte','//div["tableau_periodicite"]/div/p[normalize-space(text())="Récolte"]/following-sibling::table/tr/td[@class = "_selected3 selectionne"]/text()')
